            ...
            <div class="card shadow mb-4 border-left-primary">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-book me-2"></i>Form Tambah Mata Kuliah
                    </h6>
                </div>
                <div class="card-body">
                    <form method="post" action="<?=base_url('matakuliah/create')?>" class="needs-validation" novalidate>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Kisaran 1-3 SKS</small>
                            </div>
                        </div>
